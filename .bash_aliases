...
alias sudo='sudo '
alias backup='sudo tar -cf "/media/removable/horo/chieri.tar" --exclude-tag-all=exclude "/home/chieri"'
...
alias reloadt='xrdb -merge /home/chieri/.config/urxvt/Xresources && source ~/.bashrc'
